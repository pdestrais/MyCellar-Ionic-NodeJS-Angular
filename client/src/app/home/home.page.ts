...
import { IonRouterLink, IonHeader, IonToolbar, IonButtons, IonMenuButton, IonTitle, IonContent, IonButton, IonIcon, IonList, IonItem, IonBadge, IonSearchbar, IonSpinner, IonToggle, IonLabel } from "@ionic/angular/standalone";
...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, RouterModule, TranslateModule, IonRouterLink, IonHeader, IonToolbar, IonButtons, IonMenuButton, IonTitle, IonContent, IonButton, IonIcon, IonList, IonItem, IonBadge, IonSearchbar, IonSpinner, IonToggle, IonLabel],
})
